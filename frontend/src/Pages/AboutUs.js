...
const AboutUs = () => {
    React.useEffect(() => {
        AOS.init({ duration: 1700 }); // Initialize AOS with a duration
    }, []);
    ...
    return (
        <div className="about-us-container">
            ...
            <img src={require('../images/logo.png')} alt="GenNews Logo" className="logoWI" />
             </div>
            ...
            <footer className="about-us-footer">
                <p>Developed by: Wijdan Alhashim, Shoug Aljebreen, Lina Alharbi, And Lina Albarrak</p>
